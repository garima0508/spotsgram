...
const deletePlace = async (req, res, next) => {
  ...
  let place;
  try {
    place = await Place.findById(placeId).populate("creator"); // Place.findById(placeId) finds the place and then populates its
    // creator with the data of the user that matches with tha creator.
  } catch (err) {
    const error = new HttpError(
